...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! dataInput_lohner !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  SUBROUTINE dataInput_lohner(ndim,lnode,bnode,xyz,initVal,fname)
    IMPLICIT NONE
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! vtkIO_legacy !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  SUBROUTINE vtkIO_legacy(lnode,xyz,Pr,vfld,fname)
    IMPLICIT NONE
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! zfemIO_scalfld !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  SUBROUTINE zfemIO_scalfld(ndim,lnode,xyz,fld,fname)
    IMPLICIT NONE
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! zfemIO_vecfld !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  SUBROUTINE zfemIO_vecfld(ndim,lnode,xyz,vfld,fname)
    IMPLICIT NONE
